...
## Project Structure
    ...
    ├── yourscheduleworks_37243  # Django project configurations
...
1. Clone this repo and `cd yourscheduleworks_37243`
...
2. Clone this repo and `cd yourscheduleworks_37243`
